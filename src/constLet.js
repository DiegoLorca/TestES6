let nombre = 'Diego'; //let es el sustituto de la palabra var en js
...
let pais = 'Chile';
//let pais = 'España'; //Se genera un error en la consola, el cual indica que existe un TipeError y la linea de codigo erronea.
const pais1 = 'Argentina';
//const pais1 = 'Brasil'; //Con const pasa lo mismo
...
if(edad1 >= 18){
  let esMayor = true; //Con let o const todas las variables dentro de un bloque estaran protegidas y no se podran utilizar fuera de ella.
  //console.log(esMayor);
}//Todo lo que este dentro de llave es un bloque
//console.log(esMayor);
let nombre1 = 'Diego';//Con let se puede sobreescribir el valor
nombre1 = 'Sebastian';

const apellido1 = 'Lorca';//const (constante) es un valor que nunca va a cambiar, es por eso que arrojara Error
//apellido1 = 'Chacon'; //const lo usamos cuando queremos que el valor de una variable nunca cambie.
//console.log(nombre1 + " " + apellido1);

const colores = ['Rojo', 'Azul'];//Regularmente se ocupa const, puesto que lo ideal es no cambiar un valor pre definido a una variable.
